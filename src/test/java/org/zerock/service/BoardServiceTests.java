...
public class BoardServiceTests {
	 ...
	 * 
	 * 
	 * log.info("생성된 게시물의 번호11: " + board.getBno());
	 * 
	 * service.register(board);
	 * 
	 * log.info("생성된 게시물의 번호22: " + board.getBno()); }
	 */
	 ...
	 * 
	 * if(board == null){ System.out.println("널이자나!!!!!!!!!!!!"); return; }
	 * 
	 * System.out.println("181818"); board.setTitle("수정은무슨?");
